...
class DataAnalysis:
    ...
    def __call__(self):
        ...
        for container in self.containers:
            max_values.append(max(container.data))
        return max_values
    pass
# CODUL TĂU VINE MAI SUS:
...
class DataFilter:
    ...
    def filter_zeros(self):
        filtered_data = [num for container in self.containers for num in container.data if num != 0]
    ...
    def filter_under_mean(self, data_statistics):
        mean_value = data_statistics.mean()
        filtered_data = [num for container in self.containers for num in container.data if num > mean_value]
        return filtered_data
    pass
# CODUL TĂU VINE MAI SUS:
