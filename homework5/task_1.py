...
# CODUL TĂU VINE MAI JOS:
text = "Acesta este un text care conține cuvântul Python"
# CODUL TĂU VINE MAI SUS:
...
if "Python" in text and "Java" in text:
    ...
    print("Textul conține cel puțin unul dintre cuvintele 'Python' sau 'Java'")
else:
    print("Textul nu conține niciunul dintre cuvintele 'Python' și 'Java'")
